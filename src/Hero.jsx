...
const Hero = () => {
    return (
      <section className="relative min-h-screen flex items-center justify-center mt-[-60px] pt-65 md:mt-0 pt-10 md:pt-50 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-8 mt-37 md:mt-17 text-center">
          <h1 className="font-['Montserrat'] text-[48px] md:text-[80px] leading-[1.1] tracking-[-0.02em] font-black text-white mb-4 uppercase">
            MC AYUBZ
          </h1>
          <p className="font-['Montserrat'] text-[28px] md:text-[58px] leading-[1.2] font-bold text-[#d0c6ab] mb-12 max-w-3xl mx-auto uppercase tracking-wider">
            THE HYBRID MC🎙️ <span className="text-[#e5e2e1]"></span> <br/><span className="text-[#e9c400]">For All Events</span>
          </p>
          <div className="flex flex-row md:flex-row gap-6 justify-center items-center">
        ...
        <div className="absolute bottom-3 md:bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
