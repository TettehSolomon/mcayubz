  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center mt-[-60px] pt-65 md:mt-0 pt-10 md:pt-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-8 mt-37 md:mt-17 text-center">
        ...
        <div className="flex flex-row md:flex-row gap-6 justify-center items-center animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
      ...
      <button
        ...
        className="absolute bottom-3 md:bottom-10 left-1/2 -translate-x-1/2 animate-bounce cursor-pointer hover:scale-110 transition-transform"
      >
