...
import bgHero from "/bg_hero.jpg";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center mt-[-60px] pt-65 md:mt-0 pt-10 md:pt-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-8 mt-37 md:mt-17 text-center flex flex-col items-center">
        <h1 className="font-['Montserrat'] text-[43px] md:text-[80px] leading-[1.1] tracking-[-0.02em] font-black text-white mb-4 uppercase animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          MC AYUBZ
        </h1>
        <p className="font-['Montserrat'] text-[22px] md:text-[58px] leading-[1.2] font-bold text-[#d0c6ab] mb-12 max-w-3xl mx-auto uppercase tracking-wider animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
